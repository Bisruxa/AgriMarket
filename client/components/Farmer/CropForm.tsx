...
export function CropForm({
  ...
  return (
    ...
    >
      <DialogContent
        className={`gap-0 overflow-hidden border-gray-200 bg-white p-0 sm:max-w-2xl ${language === "am" ? "amharic" : ""}`}
      >
        ...
        <div className="max-h-[min(70vh,32rem)] overflow-y-auto px-6 py-5">
          <form id="crop-product-form" onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              >
                ...
                <SelectContent position="popper" className="z-[140] max-h-60 bg-white">
              ...
              {selectedCrop === "OTHER" && (
                <Input
                  ...
                  className="mt-2 h-11 w-full rounded-lg border-gray-200 bg-white"
                  disabled={isLoading}
                />
              )}
            </div>
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                className="w-full resize-none rounded-lg border-gray-200 bg-white"
                rows={3}
                disabled={isLoading}
              />
            </div>
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    className="h-11 w-full rounded-lg border-gray-200 bg-white pl-10"
                    disabled={isLoading}
                  />
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className="h-11 w-full rounded-lg border-gray-200 bg-white"
                  disabled={isLoading}
                />
              </div>
        ...
        <DialogFooter className="border-t border-gray-100 bg-white px-6 py-4 sm:justify-stretch">
          <Button
            type="button"
            variant="outline"
            onClick={onClose}
            className="h-11 flex-1 rounded-lg border-gray-200 bg-white"
          >
            {pf.cancel}
          </Button>
          <Button
            type="submit"
            form="crop-product-form"
            disabled={isLoading}
